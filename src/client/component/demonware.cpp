...
#pragma warning(pop)
		...
		void startup_dw()
		{
			register_stun_server("mw2-stun.us.demonware.net");
			register_stun_server("mw2-stun.eu.demonware.net");
			...
			auto lsg_server = register_server("lsg.2010.prod.demonware.net");
			auto auth_server = register_server("auth3.prod.demonware.net");
